class Smurf < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/clouddrove/smurf/releases/download/v1.1.5/smurf-v1.1.6-darwin-arm64.tar.gz"
      sha256 "5b7f667313d9e0b7f182acb07c0fe046d81611287ac564d59ad3e6d0d658ae19"
    end
    
    on_intel do
      url "https://github.com/clouddrove/smurf/releases/download/v1.1.5/smurf-v1.1.6-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/clouddrove/smurf/releases/download/v1.1.5/smurf-v1.1.6-linux-amd64.tar.gz"
      sha256 "b7fcd4214d312ac4acdaf04e198566ed6e86685cfdc359ed908327c6eced9215"
    end
    
    on_arm do
      url "https://github.com/clouddrove/smurf/releases/download/v1.1.5/smurf-v1.1.6-linux-arm64.tar.gz"
